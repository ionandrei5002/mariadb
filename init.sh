...
sudo mysql -h localhost -u root -e "USE INFORMATION_SCHEMA; DROP USER 'localuser'; CREATE USER 'localuser'@'%' IDENTIFIED BY 'admin'; GRANT ALL PRIVILEGES ON * . * TO 'localuser'@'%' IDENTIFIED BY 'admin' WITH GRANT OPTION; FLUSH PRIVILEGES;" \
